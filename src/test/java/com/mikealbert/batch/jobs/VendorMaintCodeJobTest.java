...
public class VendorMaintCodeJobTest {
    @Resource JobLauncher launcher;
    @Resource JobRepository repo;
    @Resource @Qualifier("vendorMaintCodeJob") Job vendorMaintCodeJob;
    ...
    public void testStoreLocationJobSuccessAdd() throws Exception {
    	JobExecution jobExecution = getTestUtils().launchJob(
	            ...
	            .addString("inputResource", "classpath:Maintenance_Repair_Codes_MMDDYYYY.csv")
    ...
    private JobLauncherTestUtils getTestUtils(){
    	...
    	testUtils.setJob(vendorMaintCodeJob);
    	return testUtils;
    }
